...
public class CountingServiceTest {
    ...
    public void testDivisionN() {
        ...
        model.addDenomination(new BigDecimal(50), 0, 0, 1.0f);
        model.addDenomination(new BigDecimal(100), 0, 0, 1.0f);
        model.addDenomination(new BigDecimal(20), 0, 0, 1.0f);
        model.addDenomination(new BigDecimal(5), 0, 0, 1.0f);
        model.addDenomination(new BigDecimal(1), 0, 0, 1.0f);
    ...
    public void testSmallCurrencyCombination() {
        ...
        model.addDenomination(new BigDecimal(50), 0, 0, 1.0f);
        model.addDenomination(new BigDecimal(20), 0, 0, 1.0f);
        model.addDenomination(new BigDecimal(10), 0, 0, 1.0f);
        model.addDenomination(new BigDecimal(5), 0, 0, 1.0f);
        model.addDenomination(new BigDecimal(2), 0, 0, 1.0f);
